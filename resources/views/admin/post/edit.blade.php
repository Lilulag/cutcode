                ...
                <div class="mt-8">
                    ...
                    >
                        ...
                        <input name="preview"
                               ...
                               type="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Превью" />

                        <input name="description"
                               value="{{ old('description') ?? $post->description  }}"
                               type="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Описание" />
